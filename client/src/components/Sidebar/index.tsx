  ...
  return (
    <div className={sidebarClassNames}>
      <div className="flex h-[100%] w-full flex-col justify-start">
        {/* top logo */}
        <div className="z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 ps-6 pt-3 dark:bg-black">
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          <Image src="https://pm-s3-imgs.s3.amazonaws.com/logo.png" alt="Logo" width={40} height={40} />
          <div>
        ...
        {showPriority && (
          <>
            {PrioritySidebarLinks.map((link, index) => (
              <SidebarLink key={index} {...link} />
            ))}
          </>
        )}
